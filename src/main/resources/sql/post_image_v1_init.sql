create table vblog.post_image
(
    id             bigint(40)   not null comment '用户ID',

    post_id         bigint(40)      not null comment '动态ID',
    image_url       varchar(255)    not null comment '图像地址URL',
    image_size      double          not null comment '图像大小',
...
alter table vblog.post_image add primary key (id);